...
import com.ldsight.adapter.AddDeviceListAdapter;
...
public class AddDeviceAct extends Activity {
	private JsonObjectRequest jsonObjRequest;
	private RequestQueue mVolleyQueue;
	private ArrayList<StreetAndDevice> streetAndDevices;
	AddDeviceListAdapter adapter;
	ListView listView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.add_device);
		mVolleyQueue = Volley.newRequestQueue(this);
		listView = (ListView) findViewById(R.id.add_device_list);
		streetAndDevices = new ArrayList<StreetAndDevice>();
		showProgress();
		makeSampleHttpRequest();
		LinearLayout backButton = (LinearLayout) findViewById(R.id.ll_add_device_back);
		...
		LinearLayout addButton = (LinearLayout) findViewById(R.id.ll_add_device);
		addButton.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (cku.getUserName() == null || cku.getUserpwd() == null
					...
					Intent intent = new Intent(AddDeviceAct.this,
							AddElectricBox.class);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(AddDeviceAct.this, DeviceParamAct.class);
						...
						try {
							if (response.has("streetAndDevices")) {
								try {
									...
									adapter = new AddDeviceListAdapter(
											AddDeviceAct.this, streetAndDevices);

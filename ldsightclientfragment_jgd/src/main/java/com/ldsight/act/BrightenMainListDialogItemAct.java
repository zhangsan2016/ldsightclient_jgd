...
public class BrightenMainListDialogItemAct extends Activity {
    ...
    private void setData(BrightenDevice brightenDevice) {
        ...
        if (brightenDevice != null) {
            ...
            tvTimingStages1.setText(df.format(brightenDevice.getTimingStagesList().get(0)
                    .getHour())
                    + " : "
                    + df.format(brightenDevice.getTimingStagesList().get(0).getMinute()));
            ...
            tvTimingStages2.setText(df.format(brightenDevice.getTimingStagesList().get(1)
                    .getHour())
                    + " : "
                    + df.format(brightenDevice.getTimingStagesList().get(1).getMinute()));
            ...
            tvTimingStages3.setText(df.format(brightenDevice.getTimingStagesList().get(2)
                    .getHour())
                    + " : "
                    + df.format(brightenDevice.getTimingStagesList().get(2).getMinute()));
            ...
            tvTimingStages4.setText(df.format(brightenDevice.getTimingStagesList().get(3)
                    .getHour())
                    + " : "
                    + df.format(brightenDevice.getTimingStagesList().get(3).getMinute()));
            ...
            tvTimingStages5.setText(df.format(brightenDevice.getTimingStagesList().get(4)
                    .getHour())
                    + " : "
                    + df.format(brightenDevice.getTimingStagesList().get(4).getMinute()));
            ...
            tvTimingStages6.setText(df.format(brightenDevice.getTimingStagesList().get(5)
                    .getHour())
                    + " : "
                    + df.format(brightenDevice.getTimingStagesList().get(5).getMinute()));

...
import com.ldsight.entity.HeartbeatParameter;
...
import static com.ldsight.util.HttpConfiguration._Clientuuid;
    ...
    private void sendHttp() {
        ...
        HttpUtil.sendSookiePostHttpRequest(url, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                // 保存心跳返回数据
                Gson gson = new Gson();
                HeartbeatParameter heartbeatParameter = gson.fromJson(json, HeartbeatParameter.class);

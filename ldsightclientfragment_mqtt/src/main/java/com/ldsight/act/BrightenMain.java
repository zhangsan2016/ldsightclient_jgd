...
public class BrightenMain extends Activity {
    ...
    private void showDlertDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(BrightenMain.this);
        //    设置Title的图标
            ...
            public void onClick(DialogInterface dialog, int which) {
             ...
             /*   //    设置一个NeutralButton
                builder.setNeutralButton("忽略", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(BrightenMain.this, "neutral: " + which, Toast.LENGTH_SHORT).show();
                    }
                });*/
        //    显示出该对话框
        builder.show();
    ...
    protected void settingPush(final StringBuffer start) {
    ...
    private void findViews() {
        ...
        // 控制
        tvControl = (TextView) this.findViewById(R.id.tv_control);
